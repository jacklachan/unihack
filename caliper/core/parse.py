...
ABBREVIATIONS: Dict[str, str] = {
    ...
    # "Sq" is Square far more often than Speed Queen ("Sq Edge" decking,
    # "2sq" roofing). Speed Queen is recovered from the part-number prefix
    # instead, where it is unambiguous.
    "sq": "Square", "sq edg": "Square Edge", "sq edge": "Square Edge",
    "grvd": "Grooved",
    ...
    "skylt": "Skylight", "dr": "Door", "bsmt": "Basement", "wdw": "Window",
    "fxd": "Fixed", "gld": "Gliding", "csmt": "Casement", "dbl": "Double",
    "bal": "Baluster", "rlg": "Railing", "gry": "Gray", "blk": "Black",
    "shthg": "Sheathing", "insul": "Insulation", "flshg": "Flashing",
